...
if __name__ == "__main__":
    ...
    temp_input_path = './videofkl/Input007.avi'
    temp_output_path= './videofkl/OutPut007.avi'
    ...
    print("xxxxxxxx2")
    witer = cv2.VideoWriter(temp_output_path,fourcc,5,(1280, 720),True)
    if vc.isOpened():
       print("xxxxxxxx3")
       while rat:
           print("xxxxxxxx4")
